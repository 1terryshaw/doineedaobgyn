...
// Canadian province. obgyn_listings is 100% US (5,168 rows, zero CA), so those pairs
// only ever fed generateStaticParams with 600 routes the zero-listing guard then 404s,
// and supplied display names for cities this corpus does not have. Filtering to the
// subdivisions this corpus actually serves retires all 600.
//
